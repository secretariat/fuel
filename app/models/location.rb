...
class Location < ActiveRecord::Base
	@regions = { 
							...
							"Тернополь" => 19, "Харьковск" => 20, "Херсонск" => 21,
	...
	def self.get_points(trademark)
		...
		source = "https://search-maps.yandex.ru/v1/?text=\"АЗС #{trademark}\"&type=biz&lang=ru_RU&results=1000&ll=26.813995143182623,48.80256086458314&spn=33.0908203125,12.010880536889303&apikey=82e75164-f557-47a6-a818-ef5fbf4a32ae"
